...
[TIP]
====
*Ninth Challenge:* Based on the previous command output, wait until the `postgresql-XX` image appears to solve the challenge: https://red-hat-summit-connect-hands-on-day-2024.ctfd.io/challenges#Paste%20the%20Redis%20container%20image%20version-42[Ninth Challenge Link,window=read-later]
====
